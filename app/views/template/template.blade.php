...
{{HTML::style("assets/template/css/bootstrap-responsive.min.css")}}
<link href="http://fonts.googleapis.com/css?family=Open+Sans:400italic,600italic,400,600"
        rel="stylesheet">
{{HTML::style("assets/template/css/font-awesome.css")}}
{{HTML::style("assets/template/css/style.css")}}
{{HTML::style("assets/template/css/pages/dashboard.css")}}
